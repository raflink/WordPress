	...
	function formate_shortcode()
	{
		...
		if( isset( $ux_shortcodes ) && is_array( $ux_shortcodes ) )
		{
			...
			foreach( $this->params as $pkey => $param )
			{
				...
				// popup form row end
				$row_end	= '<span class="ux-form-desc">' . $param['desc'] . '</span>' . "\n";
				$row_end   .= '</td>' . "\n";
				$row_end   .= '</tr>' . "\n";					
				$row_end   .= '</tbody>' . "\n";
			...
			if( isset( $ux_shortcodes[$this->popup]['child_shortcode'] ) )
			{
				...
				$prow_end .= '<a href="#" id="form-child-add" class="button-secondary">' . $ux_shortcodes[$this->popup]['child_shortcode']['clone_button'] . '</a>' . "\n";
				$prow_end   .= '</td>' . "\n";
				$prow_end   .= '</tr>' . "\n";					
				$prow_end   .= '</tbody>' . "\n";
